const experience = [
  {
    ...
    description:'In NCTPS Stage 2, I have learned about the operation of the boiler, turbine, generator, coal handling plant, ash handling plant, and water treatment plant. I have also learned about the operation of the ESP, ID fan, FD fan, PA fan, the cooling tower, condenser, the switchyard and the transmission of power.',
    tags: [
